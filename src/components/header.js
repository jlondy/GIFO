                    ...
                    <React.Fragment>
                        <AppBar position="fixed" style={{backgroundColor: "transparent"}} elevation={0}>
                            <Toolbar>
                                ...
                                <div>
                                    <Button color="inherit" component={Link} to="/account" style={{marginRight: "16px", borderRadius: "16px", color: "black", backgroundColor: "#61dafb"}}>Storage</Button>
                                    <Button onClick={this.handleAccountDelete} color="inherit" component={Link} to="/login" style={{marginRight: "16px", borderRadius: "16px", color: "black", backgroundColor: "#61dafb"}}>Delete Account</Button>
